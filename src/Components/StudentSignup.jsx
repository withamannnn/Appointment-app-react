...
const StudentSignup = () => {
  ...
  return (
    <div className="w-[25%] h-[52%] bg-[#3d3c3c] rounded-2xl text-white flex justify-center items-center flex-col gap-5">
      <h1 className="text-[22px]">Student Signup Portal</h1>
      <p className="text-xs text-center px-5">
        Create an account to start booking appointments and stay connected with
        your teachers
      </p>
      <form onSubmit={handleRegister} className="w-full">
        <div className="flex flex-col justify-center items-center gap-7 w-full">
          ...
          <p onClick={redirectLogin} className="text-[12px] cursor-pointer ">Already have an account??</p>
          </div>
        </div>
      </form>
    </div>
